...
%    Judul           : Diskusi Tutorial Online Sesi ke-7   
%    Tahun           : 2025
%    
%   /‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾/
%  /   SETELAN TEMPLATE   /
...
%    Bahasa Citation   : Inggris-Indonesia (singkatan Bahasa Inggris dipertahankan)
...
\fancypagestyle{head-info}{
    ...
    \fancyhead[R]{
        \begin{tblr}{colspec={r l}, vline{2}={1}{solid, gray}, cells={valign=m}, colsep=14pt, columns={fg=gray}}
            {\textit{\skemaTutorial} | \textit{Sesi \sesiKe} \\ \textit{\KodeMataKuliah} | \textit{\kodeKelas} | \textit{\namaMataKuliah}} & {\thepage\ / \pageref{LastPage}}
