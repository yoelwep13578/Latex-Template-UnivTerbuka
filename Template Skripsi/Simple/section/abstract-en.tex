...
%
\newcommand{\kataKunciENG}{%
	Analysis, E-Commerce, Appropriateness, Qualitative, Thesis.
}
%------------------------ BATAS AMAN ------------------------
...
{%
    ...
    \begin{center}
        ...
        \textit{\daerahKampus, Faculty of \fakultasENG, \prodiENG\ Study Program, \tahun}
    \end{center}
    
    \vspace{0.4cm}
    
    \begin{otherlanguage*}{american}
    \noindent\textit{\abstrakENG}
    
    \vspace{0.4cm}
    
    \noindent\textit{\textbf{Keywords:} \kataKunciENG}
    \end{otherlanguage*}
}
