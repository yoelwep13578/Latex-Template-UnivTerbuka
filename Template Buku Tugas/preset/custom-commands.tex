...
\makeatletter
\ifdef{\chapter}{%
    \ifboolexpr{ test {\ifdefstring{\template@soaljawab}{true}} or test {\ifdefstring{\template@heading}{apalike}} }{%
        \newtheorem{theorem}{\Teorema} % Teorema
        \renewcommand{\thetheorem}{\arabic{theorem}}
    }{%
        \newtheorem{theorem}{\Teorema}[chapter] % Teorema
...
\newtheorem{lemma}[lemma]{\Lema} % Lema
\aliascntresetthe{lemma}

\theoremstyle{definition}
\newaliascnt{definition}{theorem}
\newtheorem{definition}[definition]{\Definisi} % Definisi
\aliascntresetthe{definition}

\theoremstyle{remark}
\newaliascnt{example}{theorem}
\newtheorem{example}[example]{\Contoh} % Contoh
...
\NewDocumentCommand{\inlinesnippet}{v}{%
	{%
	\setlength{\fboxsep}{2pt}%
	\fcolorbox{graybr}{graybg}{\small\vphantom{gH}\lstinline{#1}}%
	}%
}
...
\newcommand{\keys}[1]{%
	{%
	\setlength{\fboxsep}{2pt}%
	\fcolorbox{graybr}{graybg}{\hspace{2pt}\footnotesize\ttfamily\vphantom{gH}#1\hspace{2pt}}%
	}%
}

\newcommand{\arrowkeys}[1]{%
	{%
	\setlength{\fboxsep}{2.4pt}%
	\fcolorbox{graybr}{graybg}{%
		\makebox[1.2em]{%
			\scriptsize\vphantom{gH}#1%
		}%
	}%
	}%
}
...
% --- Modifiers ---
\newcommand{\Ctrl}{\keys{Ctrl}}
\newcommand{\Shift}{\keys{Shift}}
\newcommand{\Alt}{\keys{Alt}}
\newcommand{\AltGr}{\keys{AltGr}}
\newcommand{\Altgr}{\AltGr}

% --- Common Navigation & Actions ---
\newcommand{\Esc}{\keys{Esc}}
\newcommand{\Enter}{\keys{Enter}}
\newcommand{\Tab}{\keys{Tab}}
\newcommand{\Space}{\keys{Space}}
\newcommand{\Backspace}{\keys{Backspace}}
\newcommand{\Capslock}{\keys{Caps Lock}}

% --- Right Side Navigation & Actions ---
\newcommand{\Insert}{\keys{Ins}}
\newcommand{\Delete}{\keys{Del}}
\newcommand{\PgUp}{\keys{PgUp}}
\newcommand{\PgDn}{\keys{PgDn}}
\newcommand{\Home}{\keys{Home}}
\newcommand{\End}{\keys{End}}

\newcommand{\Up}{\arrowkeys{\(\uparrow\)}}
\newcommand{\Down}{\arrowkeys{\(\downarrow\)}}
\newcommand{\Left}{\arrowkeys{\(\leftarrow\)}}
\newcommand{\Right}{\arrowkeys{\(\rightarrow\)}}

% --- F Key ---
\newcommand{\Fn}{\keys{Fn}}
...
\newcommand{\tablesource}[1]{\vspace{2pt}\caption*{\Sumber: #1}\vspace{-15pt}}

% --- Sumber Lampiran Gambar ---
\newcommand{\figuresource}[1]{\vspace{-10pt}\caption*{\Sumber: #1}\vspace{-10pt}}

% --- Sumber Lampiran Kode ---
\newcommand{\lstsource}[1]{\vspace{-25pt}\begin{center}\setstretch{1}\small \Sumber: #1 \vspace{10pt}\end{center}}

% --- Link Email ---
\newcommand{\emailref}[1]{\href{mailto:#1}{{\url#1}}}
