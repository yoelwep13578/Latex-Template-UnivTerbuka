...
\newcommand{\judul}{Peran Mahasiswa dalam Mewujudkan Indonesia Maju}
...
\newcommand{\namaMataKuliah}{Bahasa Indonesia}
\newcommand{\kodeMataKuliah}{MKWU4108}
\newcommand{\KodeMataKuliah}{MKWU-4108}

\newcommand{\kodeKelas}{964}

\newcommand{\namaTutorPengampu}{Andi Batara Indra, S.Pd., M.Pd.}

% Informasi Mahasiswa
\newcommand{\namaMahasiswa}{Yoeru Sandaru}
\newcommand{\nimMahasiswa}{081298765432}
\newcommand{\programStudi}{Sistem Informasi}
\newcommand{\kodeProgramStudi}{/252}
\newcommand{\fakultas}{Sains dan Teknologi}
\newcommand{\kodeFakultas}{/2}
\newcommand{\utDaerah}{UT Jakarta}
\newcommand{\kodeUTDaerah}{/21}
\newcommand{\perguruanTinggi}{Universitas Terbuka}
\newcommand{\daearhMahasiswa}{Jakarta}
...
\addto\captionsindonesian{\renewcommand{\bibname}{Daftar Rujukan}} % Bibliography
\addto\captionsindonesian{\renewcommand{\refname}{Daftar Rujukan}} % Reference
