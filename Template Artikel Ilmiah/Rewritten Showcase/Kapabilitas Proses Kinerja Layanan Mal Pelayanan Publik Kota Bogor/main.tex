...
%    
%    Penulis         : [1] Liah Lestari
%                      [2] Dewi Juliah Ratnaningsih
%    Status Penulis  : [1] Mahasiswa
%                      [2] Lektor Kepala
%    Alamat Afiliasi : [1,2] Program Studi Statistika,
%                            Fakultas Sains dan Teknologi,
%                            Universitas Terbuka
%    Korespondensi   : [2] djuli@ecampus.ut.ac.id
%    
%    Judul           : Kapabilitas Proses Kinerja Layanan Mal Pelayanan Publik
%                      Kota Bogor
%    Tahun Terbit    : 2020
...
%    Nomor           : 2
%    Halaman         : 99--110
%    DOI/Link        : https://doi.org/10.33830/jmst.v21i2.878.2020
%    
%    /‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾/
%   /                DIFF: HEADING                /
...
%    
%    Afiliasi Penulis  : Mahasiswa + Dosen (dimodifikasi dgn E-mail dosen)
%    Penomoran Heaidng : Low Level/Kemungkinan Tidak Ada Numbering
