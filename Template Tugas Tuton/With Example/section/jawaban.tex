...
\begin{table}[H]
    ...
    \begin{tblr}{colspec={c l X{l} X{l}}, hline{1,2,Z}={1-Z}{1pt, solid}, row{3}={bg=yellow!30}, row{1}={c}}
        ...
        1. & Chapter & \texttt{\textbackslash chapter\{TEKS\}} & \texttt{\textbackslash chapter*\{TEKS\}} \\
        2. & Section & \texttt{\textbackslash section\{TEKS\}} & \texttt{\textbackslash section*\{TEKS\}} \\
        3. & Subsection & \texttt{\textbackslash subsection\{TEKS\}} & \texttt{\textbackslash subsection*\{TEKS\}} \\
        4. & Subsubsection & \texttt{\textbackslash subsubsection\{TEKS\}} & \texttt{\textbackslash subsubsection*\{TEKS\}} \\
        5. & Paragraph & \texttt{\textbackslash paragraph\{TEKS\}} & \texttt{\textbackslash paragraph*\{TEKS\}} \\
        6. & Subparagraph & \texttt{\textbackslash subparagraph\{TEKS\}} & \texttt{\textbackslash subparagraph*\{TEKS\}}
    \end{tblr}
\end{table}

Saat Anda hendak menulis \textit{heading} di dalam bagian Soal dan Jawaban, mulailah dari \textit{Section} --- seperti yang di-\textit{highlight} pada \autoref{table:jenis-heading}.
